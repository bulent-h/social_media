...
const CommentModal = ({ show, comments, handleClose, handleSubmit, post }) => {
    ...
    return (
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 ">
            <div className="modal-content bg-white w-3/4 md:w-1/2 lg:w-1/3 p-6 rounded-lg shadow-lg relative dark:bg-gray-900">
                ...
                <h2 className="text-xl mb-4 text-purple-700 dark:text-white">Comments</h2>
                ...
                <div className="mb-4 relative">
                    <form onSubmit={(e) => handleSubmit(e, commentContent, setCommentContent)}>
                        <input
                            ...
                            className="w-full border rounded-full px-6 py-2 bg-gray-100 focus:border-cyan-600 border-purple-600 pr-10 focus:outline-none focus:ring-0 dark:bg-gray-700 dark:text-gray-100" // add padding right to make room for the button
                            placeholder="Add a comment..."
                        />
                        <button
                            type="submit"
                            className={`absolute right-2 top-2 text-lg ${commentContent ? 'text-purple-500' : 'text-gray-400 dark:text-white'}`}>
