...
export default function UpdatePrivacyInformation({ mustVerifyEmail, status, className = '' }) {
                ...
                <div className='grid grid-cols-12 gap-4'>
                    ...
                    <div className='my-4 col-span-12 grid grid-cols-12 gap-4'>
                        <div className='col-start-2 col-span-5 flex items-center justify-start '>
                            ...
                            <InputLabel className="font-semibold" htmlFor="stories" value="Who can see my stories" />
                        </div>
