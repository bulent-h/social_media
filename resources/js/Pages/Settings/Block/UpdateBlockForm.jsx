...
export default function UpdateBlockForm({ mustVerifyEmail, status, className = '' }) {
    ...
    function handleUnblockUser(unblocked) {

        axios.post(route('user.unblock.post', { user: unblocked }))
            .then((response) => {
                fetchUsers();
    ...
    return (
        <section className={className}>
                ...
                <div className='grid grid-cols-12 gap-4'>
                    ...
                    <div className='my-4 col-span-12 grid grid-cols-12 gap-4'>
                        <div className='col-start-2 col-span-5 flex items-center justify-start '>
                            ...
                            <InputLabel className="font-mono" value="Who can see my stories" />
                        </div>
            ...
            <Modal show={searchModal} onClose={closeModal}>
